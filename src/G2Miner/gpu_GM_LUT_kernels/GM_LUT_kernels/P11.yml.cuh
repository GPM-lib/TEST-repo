...
GM_LUT_warp(vidType begin, vidType end, 
  ...
  for(vidType v0_idx = begin + warp_id; v0_idx < candidate_v0.size(); v0_idx += num_warps){
    ...
    for (vidType v1_idx = 1; v1_idx < candidate_v1.size(); v1_idx += 1) {
      ...
      for(vidType v2_idx = 0; v2_idx < candidate_v2.size(); v2_idx ++){
        ...
        __difference(meta, __get_vmap_from_heap(g, meta, /*bitmap_id=*/-1, /*slot_id=*/4), __get_vlist_from_graph(g, meta, /*vid=*/v2), /*upper_bound=*/-1, /*output_slot=*/2);
        __intersect(meta, __get_vmap_from_heap(g, meta, /*bitmap_id=*/-1, /*slot_id=*/4), __get_vlist_from_graph(g, meta, /*vid=*/v2), /*upper_bound=*/-1, /*output_slot=*/3);
